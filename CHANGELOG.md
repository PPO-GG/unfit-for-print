...
* **server:** add admin issue list, detail, and status routes ([b57679b](https://github.com/PPO-GG/unfit-for-print/commit/b57679bee724e5ed4442c7858621d1d81e7a5cb1))
* **server:** add card move route for pack rename, merge and reassignment ([c92ef13](https://github.com/PPO-GG/unfit-for-print/commit/c92ef13c28d0f2cff66921d209e9f1a9b6b69cb3))
* **server:** add card_packs metadata table ([9133985](https://github.com/PPO-GG/unfit-for-print/commit/913398554d1a782a0478a8c7f278b4b0a9aba2c5))
* **server:** add issue fingerprinting and shared issue types ([961b9a7](https://github.com/PPO-GG/unfit-for-print/commit/961b9a79ce8024b1477ac97caa9bcb0724e02c0f))
* **server:** add issue_groups and issue_events tables ([67b625f](https://github.com/PPO-GG/unfit-for-print/commit/67b625fed8aa47c43549bd24caa58413b4d9e6d2))
* **server:** add pack metadata routes and clear metadata on pack delete ([8636a1c](https://github.com/PPO-GG/unfit-for-print/commit/8636a1c2d102f44b7e9850dea3d7c7c4acbdc03b))
* **server:** add planPackMove rule for pack rename and merge ([93c2ab6](https://github.com/PPO-GG/unfit-for-print/commit/93c2ab6125952f43aede15412a3f6ffad29fd4b0))
* **server:** add unauthenticated issue report ingest route ([14bf2ac](https://github.com/PPO-GG/unfit-for-print/commit/14bf2acce5e5a772a94e67974fe344fa0f17fa43))
* **server:** age out issue events and long-closed groups ([ea3593b](https://github.com/PPO-GG/unfit-for-print/commit/ea3593b0e21cbb6556abdf61be07097d25cc001b))
* **server:** alert Discord on new issue groups and regressions ([82c3b96](https://github.com/PPO-GG/unfit-for-print/commit/82c3b967033797c358643bc09ce23622ee9ee893))
* **server:** capture 5xx errors from server/api/* into the issue pipeline ([6497f13](https://github.com/PPO-GG/unfit-for-print/commit/6497f13724e23778fe75abc86fe7749b9b4feba2))
* **server:** forward teleportal-server crashes into the issue pipeline ([c74bbca](https://github.com/PPO-GG/unfit-for-print/commit/c74bbcaffd0941907e12b492c2c05ff05e4074f3))
* **server:** persist issue groups and events with a per-group cap ([d0e8fca](https://github.com/PPO-GG/unfit-for-print/commit/d0e8fca4a0c0b9218ddf5b3373fe17b5774a1233))
* **server:** validate and truncate issue report payloads ([f2942ec](https://github.com/PPO-GG/unfit-for-print/commit/f2942ec52cefb367b44448ef377b02bacbd03d83))
* **web:** add a host-only watchdog for game states that wedge silently ([943c33b](https://github.com/PPO-GG/unfit-for-print/commit/943c33b96e9e69df5cd42e5801c06c60dd72bde3))
* **web:** add admin card filter bar with live type counts ([bfa04d7](https://github.com/PPO-GG/unfit-for-print/commit/bfa04d703a97c50dc855840e09ca55c3e09c67c1))
* **web:** add admin issue inbox and detail pages ([89b1349](https://github.com/PPO-GG/unfit-for-print/commit/89b13499def499f4aa8a90ef7d2a048369e14968))
* **web:** add admin pack tile ([7b68986](https://github.com/PPO-GG/unfit-for-print/commit/7b68986de3fbd22e586abc8b6a49add388100a47))
* **web:** add an in-game and main-menu report a problem flow ([c9ee3c0](https://github.com/PPO-GG/unfit-for-print/commit/c9ee3c0a9ce37aff36132ce1acf52de6c898429b))
* **web:** add card selection state to the admin card list ([0d7151a](https://github.com/PPO-GG/unfit-for-print/commit/0d7151a8276f3761f390a0ef94cfd7f8c576e359))
* **web:** add docked bulk selection bar with a move popover ([552b7dc](https://github.com/PPO-GG/unfit-for-print/commit/552b7dcb73158bfdd6e600821a5d8453179eb256))
* **web:** add in-place admin card editor for the inspector ([9c33ceb](https://github.com/PPO-GG/unfit-for-print/commit/9c33ceb1db9d721cb2e94d7cf394102c5b07dd6c))
* **web:** add issue reporter composable with dedupe and session caps ([5e1d5bc](https://github.com/PPO-GG/unfit-for-print/commit/5e1d5bcb173fac021b17e99413b25b031eb904cf))
* **web:** add move, rename and merge mutations to the admin card manager ([c7577b9](https://github.com/PPO-GG/unfit-for-print/commit/c7577b90e997a41685e8b0dc8169189d49be90bc))
* **web:** add pack details editor modal ([29ad0a5](https://github.com/PPO-GG/unfit-for-print/commit/29ad0a581339909229907f18060fa1f3f35f2503))
* **web:** add reusable admin pack picker ([646eb89](https://github.com/PPO-GG/unfit-for-print/commit/646eb898b44f5b14e1dc57c817f80a5409158cf2))
* **web:** add thin pack rail for the card browser ([141aea9](https://github.com/PPO-GG/unfit-for-print/commit/141aea91b4b9d8af8ad6fbb5e268bcfafc9a97a8))
* **web:** add three-state admin card inspector ([60d1fc2](https://github.com/PPO-GG/unfit-for-print/commit/60d1fc251207674691cfe630441a2117006e0983))
* **web:** add viewport-locked admin card browser ([30848bd](https://github.com/PPO-GG/unfit-for-print/commit/30848bd5b65cb1ce43638f97ab0e401fab06c406))
* **web:** add windowed admin card grid and its geometry helper ([8120159](https://github.com/PPO-GG/unfit-for-print/commit/81201591c08c6eaa6caaed70a5c089ef69b0bb41))
* **web:** capture unhandled client errors with live game context ([555445f](https://github.com/PPO-GG/unfit-for-print/commit/555445f744722a910fb7f5beadbcf9b53ad62438))
* **web:** count packs and cards across the Labs filters ([34ee86c](https://github.com/PPO-GG/unfit-for-print/commit/34ee86c2aee9ece6897a57d97ed4b5dda0a82a37))
* **web:** derive admin card win and skip rates with a small-sample guard ([84700d1](https://github.com/PPO-GG/unfit-for-print/commit/84700d1ed715c33b5919c89c7396839289c2e469))
* **web:** enlarge menu tile text ([785aa3a](https://github.com/PPO-GG/unfit-for-print/commit/785aa3aa79acbe9395531c020b773dd3e60a4641))
* **web:** give admin card tiles a persistent checkbox and drop the hover overlay ([7f78aa0](https://github.com/PPO-GG/unfit-for-print/commit/7f78aa03366ff47ef098131602ada4dd1950b793))
* **web:** let the host shuffle a random spread of card packs ([67caba6](https://github.com/PPO-GG/unfit-for-print/commit/67caba67cdd5e32c5326c3ade097acdeebda891f))
* **web:** make pack tiles legible and give the packs screen search and filters ([f0183c7](https://github.com/PPO-GG/unfit-for-print/commit/f0183c7914c130cf7ef7daf1fc9c5dfac38e87db))
* **web:** mirror card moves, pack renames and merges in admin pack stats ([c76c708](https://github.com/PPO-GG/unfit-for-print/commit/c76c7080962129c141ce325036bdef1fbacd572f))
* **web:** replace admin card pagination with sorting ([54c35d6](https://github.com/PPO-GG/unfit-for-print/commit/54c35d6a822aff1b0b73eea15dd7365f5176e422))
* **web:** replace the card manager sidebar with a packs index screen ([992fc94](https://github.com/PPO-GG/unfit-for-print/commit/992fc94c865f9c5223a8044924b7c43ff75f52dd))
* **web:** surface card play statistics and rate sorting in the admin ([ddd634e](https://github.com/PPO-GG/unfit-for-print/commit/ddd634eea97675a1d53d07836a72c0561e72afa0))
* **web:** tag admin cards with their type and merge the All filter ([9fd9afc](https://github.com/PPO-GG/unfit-for-print/commit/9fd9afc8fc37cf2cc2230882e372360465d9ddf6))
* **web:** wire pack move, rename, merge and details into the card manager ([f7a5642](https://github.com/PPO-GG/unfit-for-print/commit/f7a5642ae0450126e4ffc252c8187b7f928ead3c))


### 🐛 Bug Fixes

* **deps:** bump vitest to 4.1.11, fixing a path-traversal alert ([782995d](https://github.com/PPO-GG/unfit-for-print/commit/782995dc750d771fc4787d7101f57af5e53132d0))
* **deps:** pin qs and @tiptap/core/pm to patched versions ([0abf65c](https://github.com/PPO-GG/unfit-for-print/commit/0abf65c73ce6c9bc08b0ec60322cfca074c7b5d4))
* **server:** clamp admin issue list pagination and validate kind/status filters ([0fcd620](https://github.com/PPO-GG/unfit-for-print/commit/0fcd620da6b64c8beb22f20a791402e82f1cad6f))
* **server:** correct quoted-string regex to not treat contractions as delimiters ([377f92c](https://github.com/PPO-GG/unfit-for-print/commit/377f92c35d00bbf5eb227f01e7347980ddf0cc79))
* **server:** escape appVersion in issue webhook alert ([1f951d5](https://github.com/PPO-GG/unfit-for-print/commit/1f951d501aa1072630b98766ec21ccd652976717))
* **server:** fix concurrent regression alerts and cap-test boundary ([c786ff3](https://github.com/PPO-GG/unfit-for-print/commit/c786ff37d3c6ef5d5a4d4ffa39ca2c33823207b4))
* **server:** gate issue-report body size before parsing and measure bytes ([4394afe](https://github.com/PPO-GG/unfit-for-print/commit/4394afe0571babdaad716a8f13ff7dbbf26db6ab))
* **server:** report the aux-row outcome from card moves and delete packs atomically ([983f6b0](https://github.com/PPO-GG/unfit-for-print/commit/983f6b01e7f7eade94f936328bf8bb041119f7e2))
* **server:** sanitize issue webhook mentions, honor shouldNotify, and widen fail-open guard ([3ea12c1](https://github.com/PPO-GG/unfit-for-print/commit/3ea12c1a4ae075bdafff09b8b00a78dff640fd49))
* **server:** sanitize webhook markdown, harden ingest, and fix the cap/retention seams ([0bd2a04](https://github.com/PPO-GG/unfit-for-print/commit/0bd2a04fc335790e6a9b2fe04ee39f82fb5ee3df))
* **server:** validate context values and extract caps to constants ([350cf78](https://github.com/PPO-GG/unfit-for-print/commit/350cf78ffcc026120b47b7b7a482b43892c6883f))
* **web:** admin cards manager polish + editable pack series/brand ([#108](https://github.com/PPO-GG/unfit-for-print/issues/108)) ([8ae5cbc](https://github.com/PPO-GG/unfit-for-print/commit/8ae5cbcaa7e04517eb4876df4837b382dbb6e47f))
* **web:** associate the pack picker label with its input ([07db574](https://github.com/PPO-GG/unfit-for-print/commit/07db5740dee2e3b32ccd3152347e428df29ac6d2))
* **web:** clear issue-reporter context provider in useLobbyDoc.disconnect ([ab398db](https://github.com/PPO-GG/unfit-for-print/commit/ab398db84e586126a7438678cf7661f5dc2d7b3b))
* **web:** correct card manager type filtering, selection, and image-card editing ([3117fad](https://github.com/PPO-GG/unfit-for-print/commit/3117fadbb67ee36d5ebdd7f3b6b10fc6fecaccb4))
* **web:** degrade gracefully on an unknown card sort value ([c247549](https://github.com/PPO-GG/unfit-for-print/commit/c2475498eb65aba96e22e627d9731fab87f5a088))
* **web:** derive card grid row height from the tile's aspect ratio ([3fbe0e8](https://github.com/PPO-GG/unfit-for-print/commit/3fbe0e8e5102a77df460ce08f4142ba2e18034a2))
* **web:** drop a template comment that broke hydration around ReportProblemModal ([be2d5ba](https://github.com/PPO-GG/unfit-for-print/commit/be2d5baf1bb03887cb18855ff82890e1273f51bf))
* **web:** group thousands in the card filter bar counts ([a71c635](https://github.com/PPO-GG/unfit-for-print/commit/a71c6353b35ba54fe926db9ee8723d6082df6add))
* **web:** guard hand.length read against null ([1f951d5](https://github.com/PPO-GG/unfit-for-print/commit/1f951d501aa1072630b98766ec21ccd652976717))
* **web:** guard the card editor against re-emitting the last saved edit ([4b19e35](https://github.com/PPO-GG/unfit-for-print/commit/4b19e353fadbd157d4f3724c152cda851983b9c6))
* **web:** handle setStatus failures and add a Reopen action to the issue inbox ([958d45c](https://github.com/PPO-GG/unfit-for-print/commit/958d45c7ba81cb5426c361ccf99c36972c3d019a))
* **web:** keep the admin pack mirror truthful across search-mode moves and partial merges ([28a2cc4](https://github.com/PPO-GG/unfit-for-print/commit/28a2cc44138fdca22271398128553d0b2507770e))
* **web:** mirror pack moves by the server's verdict, chunk large moves, and tidy the dialogs ([fa75749](https://github.com/PPO-GG/unfit-for-print/commit/fa7574996316c9c5cc91add3fa239f0395e114c4))
* **web:** move the inspected card, keep search in the URL, and report bulk deletes honestly ([1c2c8d8](https://github.com/PPO-GG/unfit-for-print/commit/1c2c8d8baf241c9d37d1a38d437104fb9fd8d1c2))
* **web:** move the judge's skip control under the prompt card ([c59263c](https://github.com/PPO-GG/unfit-for-print/commit/c59263c627d3d691c5edb913299d9782477d349c))
* **web:** populate isHost and handSizes in the issue context provider ([fce2fdc](https://github.com/PPO-GG/unfit-for-print/commit/fce2fdc2e4ce814f77fd94aa0c3bf09f588861a5))
* **web:** preserve issue-reporter context across connect() resets ([d5e059b](https://github.com/PPO-GG/unfit-for-print/commit/d5e059b896839a3917fa11db594a336a6ba4c267))
* **web:** restore pack tile click targets, pack actions, and metadata form tests ([c23dd20](https://github.com/PPO-GG/unfit-for-print/commit/c23dd206b93f0b4f181a499df3f50eb46909baa7))
* **web:** show which admin cards are selected ([6dd6f15](https://github.com/PPO-GG/unfit-for-print/commit/6dd6f15de26ee2211c2aea585e3f7043ae41822c))
* **web:** split cross-type bulk moves into one request per card type ([6fac462](https://github.com/PPO-GG/unfit-for-print/commit/6fac462729356e68ea3af6518e37c07a92fbfebf))
* **web:** stop a skipped prompt shifting the card and racing the bots ([2dc1633](https://github.com/PPO-GG/unfit-for-print/commit/2dc163334ebf757cecbca73c557a71e92e50776c))
* **web:** stop rename and merge stacking a confirm dialog on their own modal ([0a91337](https://github.com/PPO-GG/unfit-for-print/commit/0a91337042baa41d3dbac922fa08c9f1cfa26520))
* **web:** stop the card editor saving the same edit twice ([644456c](https://github.com/PPO-GG/unfit-for-print/commit/644456c2767470950ed8f40455f8652eebf9644c))
* **web:** update card selection tests for the removed page slice ([355d9fd](https://github.com/PPO-GG/unfit-for-print/commit/355d9fd83c66880024a72c1fedb64fc47961ab93))
* **web:** use a sentinel instead of an empty value for the issue filter All options ([22d156e](https://github.com/PPO-GG/unfit-for-print/commit/22d156ea7a7584824d55125d632ce5a0d8bd317c))
* **web:** use each card's own type for single-card toggle and delete ([cd3d57e](https://github.com/PPO-GG/unfit-for-print/commit/cd3d57e3ec90546b09cdfec25e7a4e8598da84e7))


### 📖 Documentation

* **web:** add BlackCard to the known-failing suite baseline ([f291ca9](https://github.com/PPO-GG/unfit-for-print/commit/f291ca9169ce956cc5e888e9f135537917e79024))
