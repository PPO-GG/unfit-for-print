	...
	<div class="w-full bg-gradient-to-b from-slate-900 to-slate-800 min-h-screen flex flex-col">
		...
		<div class="min-h-screen flex flex-col">
			...
			<main class="flex-1 p-2 md:p-6 flex flex-col overflow-hidden relative">
				...
				<div class="w-full max-w-6xl mx-auto mt-4 md:mt-16 mb-6 flex flex-col md:flex-row justify-center items-center md:items-start gap-6 md:gap-12">
					<!-- Black Card Deck -->
					<BlackCardDeck :black-card="blackCard" class="transform scale-90 md:scale-100 origin-center" />

					<!-- White Card Deck -->
					<WhiteCardDeck class="transform scale-90 md:scale-100 origin-center" />
				</div>
