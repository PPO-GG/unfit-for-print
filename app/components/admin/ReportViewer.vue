  ...
  <div>
    ...
    <div v-else-if="reports.length === 0" class="text-center py-8">
      <UIcon
        ...
        class="text-5xl text-green-500 mb-2"
      />
    ...
    <ul v-else class="space-y-4">
      <li
        ...
        :key="report.$id"
        class="bg-slate-700 p-4 rounded text-white cursor-default"
      >
        <div class="flex justify-between items-center">
          <div @click.stop>
            <div class="flex items-center gap-2">
              ...
              <span class="text-gray-300 text-sm"
                >Reported: {{ formatDate(report.$createdAt) }}</span
              >
            </div>
          ...
          <UButton
            ...
            color="primary"
            @click.stop="viewCardDetails(report)"
          >
            View
          </UButton>
        </div>
    ...
    <!-- Card Details Modal -->
    <UModal v-model:open="showCardDetails" :ui="{ content: 'sm:max-w-xl' }">
