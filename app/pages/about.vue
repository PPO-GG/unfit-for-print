...
<template>
  <div>
    ...
    <aside
      class="hidden lg:flex flex-col overflow-y-auto py-8"
      :style="{
        position: 'fixed',
    ...
    <!-- Main content: left margin on desktop to clear the fixed sidebar -->
    <div class="lg:pl-[256px] max-w-6xl mx-auto px-6 sm:px-10 lg:pr-16">
      <div class="py-8 min-w-0">
          ...
          <div class="relative">
            ...
            <div class="space-y-6">
              ...
              >
                ...
                >
                  <UIcon :name="phase.icon" :class="['text-xl', phase.color]" />
                </div>
                <div
