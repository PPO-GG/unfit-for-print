...
<template>
	<footer>
		...
		<div class="fixed bottom-0 hidden w-full items-center p-4 backdrop-blur-2xl text-white shadow-md font-['Bebas_Neue'] text-2xl font-medium border-t-2 border-slate-700/25 gap-10 sm:flex">
	...
	<UModal v-model:open="uiStore.showPolicy" title="Unfit For Print Privacy Policy" fullscreen class="m-4 rounded-lg backdrop-blur-2xl bg-slate-900/50">
		<template #body>
			<PrivacyPolicy />
		</template>
		<template #footer>
			Last updated: April 14, 2025 · © <span class="font-medium">Unfit for Print</span>
		</template>
	</UModal>
</template>
