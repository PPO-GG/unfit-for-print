<template>
  <div class="">
		<div class="flex flex-col items-center m-8">
			<svg class="text-white w-lg mx-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 920.08 767.72" stroke="black" stroke-width="5px" stroke-miterlimit="10">
			...
			<p class="font-['Bebas_Neue'] w-lg text-3xl select-none">A PARTY GAME FOR HIDEOUS PEOPLE</p>
		</div>
